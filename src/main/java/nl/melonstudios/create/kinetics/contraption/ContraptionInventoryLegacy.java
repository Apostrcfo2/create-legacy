...
@Deprecated
public class ContraptionInventoryLegacy {
    ...
    public static ContraptionInventoryLegacy empty() {
        return Empty.INSTANCE;
    }

    private static class Empty extends ContraptionInventoryLegacy {
        private static final ContraptionInventoryLegacy INSTANCE = new Empty();
