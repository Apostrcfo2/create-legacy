...
public class CreateLegacyPacketManager {
    ...
    public void onPacketData(FMLNetworkEvent.ClientCustomPacketEvent event) {
        ...
        if (handler == null) {
            CreateLegacy.logger.error("Received unknown clientbound packet of ID #{}", Byte.toUnsignedInt(type));
        } else {
            try {
                ...
                CreateLegacy.logger.error("Exception on clientbound packet of ID #{}", Byte.toUnsignedInt(type));
    ...
    public void onPacketData(FMLNetworkEvent.ServerCustomPacketEvent event) {
        ...
        if (handler == null) {
            CreateLegacy.logger.error("Received unknown serverbound packet of ID #{}");
        } else {
            try {
                ...
                CreateLegacy.logger.error("Exception on serverbound packet of ID #{}", Byte.toUnsignedInt(type));
